...
installpacker() {
	git clone git@github.com:wbthomason/packer.nvim.git ~/.local/share/lunarvim/site/pack/packer/start/packer.nvim
}
...
cloneconfig() {
	...
	*--testing*)
		...
		;;
	*)
		git clone --branch "$LVBRANCH" git@github.com:LunarVim/LunarVim.git ~/.local/share/lunarvim/lvim
		;;
	esac
